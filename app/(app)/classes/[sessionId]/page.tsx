      ...
      <main className="container mx-auto px-4 py-8 overflow-x-hidden">
        ...
        <div className="grid gap-8 md:grid-cols-3 lg:grid-cols-3">
          ...
          <div className="md:col-span-2 lg:col-span-2 space-y-6">
            {/* Hero Image */}
            <div className="relative aspect-3/2 sm:aspect-video rounded-2xl overflow-hidden bg-muted">
              {activity?.images?.[0] ? (
                <Image
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex gap-4 flex-col sm:flex-row">
                    {venue.images?.[0] && (
                      <div className="relative w-full sm:w-24 h-48 sm:h-24 rounded-xl overflow-hidden bg-muted shrink-0">
                        <Image
              ...
              <Card>
                ...
                <CardContent>
                  <VenueMap
                    ...
                    className="aspect-3/2 sm:aspect-video rounded-xl overflow-hidden"
                  />
                </CardContent>
              </Card>
            )}
          ...
          <div className="md:col-span-1 lg:col-span-1">
            <Card className="lg:sticky lg:top-4 shadow-lg border-primary/10">
