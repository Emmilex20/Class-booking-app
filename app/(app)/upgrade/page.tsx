import SafePricingTable from "@/components/app/billing/SafePricingTable";
...
export default async function UpgradePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="border-b bg-linear-to-br from-primary/10 via-background to-primary/5">
